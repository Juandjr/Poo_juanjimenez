				  ...
				  while (opc1!=5) {
					  ...
					  case 1:
						...
						System.out.println("Comisiones agregadas al valor final correctamente");
						  System.out.println("Ingrese el rango de seguridad del Docente (del 1 al 5): ");
						  f = sc.nextInt();
						  ...
						  System.out.println("El rango de seguridad del docente es: "+docente.rango);
					  ...
					  case 2:
						  ...
						  System.out.println("Ingrese el rango de seguridad del Tecnico (del 1 al 5): ");
						  f = sc.nextInt();
					  ...
					  case 3:
						  ...
						  System.out.println("Ingrese el rango de seguridad del Administrativo (del 1 al 6): ");
						  f = sc.nextInt();
					  ...
					  case 4:
						  ...
						  System.out.println("El rango de seguridad del de la Limpieza es: "+limpieza.rango);
